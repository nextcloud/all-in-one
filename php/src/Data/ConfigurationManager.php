...
class ConfigurationManager
{
    ...
    public string $desecApiBase {
        get => $this->getEnvironmentalVariableOrConfig('DESEC_API_BASE', 'desec_api_base', 'https://desec.io/api/v1');
    }
    ...
    public string $desecUpdateUrl {
        get => $this->getEnvironmentalVariableOrConfig('DESEC_UPDATE_URL', 'desec_update_url', 'https://update.dedyn.io/');
    }
