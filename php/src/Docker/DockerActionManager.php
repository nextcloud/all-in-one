...
class DockerActionManager
{
    ...
    private function ConnectContainerIdToNetwork(Container $container) : void
    {
    ...
    {
        $container = $this->containerDefinitionFetcher->GetContainerById('nextcloud-aio-mastercontainer');

        $this->ConnectContainerIdToNetwork($container);
    }
