...
- if you are using caddy community container, this will be available at https://glances.your-server.com, For security reasons, a password will be generated and shown in the AIO interface (if you click on showing the secret for glances)
