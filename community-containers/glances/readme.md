...
- if you are using caddy community container, this will be available at https://glances.your-server.com, For security reasons, a random password will be generated and shown in AIO configuration
