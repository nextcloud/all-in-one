...
- There are also some pre-made scripts that make configuring some of the community containers easier. For example LLDAP, Facerecognition, edit the config.php inside Nextcloud and more? # TODO (also document this in other places)
