...
### Nextcloud AIO provides easy deployment and maintenance with most features in only one single domain instance, including:

- **Nextcloud**

- High performance backend for **Nextcloud Files**

- Optional [Community containers](https://github.com/nextcloud/all-in-one/tree/main/community-containers#community-containers):
  - **Nextcloud Office**
...
- See all containers' logs directly for easy debugging
- [Easy updates](https://github.com/nextcloud/all-in-one#how-to-update-the-containers) for all containers, Nextcloud, and its apps

## Daily Backup and Easy Restore and Migration

- Fully managed from the AIO interface, including integrity check repair
- Configurable with [external scripts](https://github.com/nextcloud/all-in-one#how-to-stopstartupdate-containers-or-trigger-the-daily-backup-from-a-script-externally) (see a [complete example](https://github.com/nextcloud/all-in-one#how-to-enable-automatic-updates-without-creating-a-backup-beforehand))
- Supports [remote backup](https://github.com/nextcloud/all-in-one#are-remote-borg-backups-supported)
- Back up external Docker Volumes or Host paths (for host backups)
- [Migrate](https://github.com/nextcloud/all-in-one/blob/main/migration.md) from any former Nextcloud installation
- Adjustable remote path repository for local backups on multiple drives
