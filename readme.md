...
<details>
  ...
  - `--cpu-shares 4096` — gives the mastercontainer four times the default CPU share weighting (default is 1024), ensuring it stays responsive under heavy load from sibling containers.  
