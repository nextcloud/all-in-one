...
sed -i 's|NEXTCLOUD_TEMPDIR=|NEXTCLOUD_TEMPDIR=/tmp/nc-tmpdir          # This allows the Nextcloud container to access a custom temporary directory on the host.|' sample.conf
